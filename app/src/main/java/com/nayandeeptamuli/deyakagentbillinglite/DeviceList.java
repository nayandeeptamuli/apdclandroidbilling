...
public class DeviceList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetoothprinter_layout_billing_device_list);   //显示列表界面
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.bluetoothprinter_layout_billing_device_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.bluetoothprinter_layout_billing_device_name);
        ...
        if (pairedDevices.size() > 0) {
            ...
            String noDevices = "No Device Paired";
